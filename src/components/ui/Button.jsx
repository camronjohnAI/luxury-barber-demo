const variants = {
  primary: 'gold-gradient text-black font-semibold hover:opacity-90 shadow-lg shadow-gold/20',
  secondary: 'border border-gold text-gold hover:bg-gold hover:text-black',
  ghost: 'text-cream hover:text-gold',
  dark: 'bg-charcoal-light text-cream border border-charcoal-border hover:border-gold/50',
}
